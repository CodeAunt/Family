...
public class VariableDataUtil {
    ...
    public static String phone= "18580543261";//标明自己身份
    public static String groupname = "陌默的圈圈";//标明自己身份
    public static String groupcode = "111111";//标明自己身份
    public static String headImgUrl = "https://tucao.qq.com/static/desktop/img/products/def-product-logo.png";

    public static String APPKEY = "2a8415a18c460";
    public static String APPSECRET = "669c4c3789ad0ee33380784f343d31e9";
}
